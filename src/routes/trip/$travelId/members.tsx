...
import { Users, UserPlus, Mail, Settings, Crown, Shield, Eye } from "lucide-react";
					...
					<div className="flex gap-4 text-sm">
						...
						{pendingInvitesCount > 0 && (
							<Badge variant="outline" className="gap-2">
								...
								<span>{pendingInvitesCount} pendente{pendingInvitesCount !== 1 ? 's' : ''}</span>
							</Badge>
						)}
					</div>
					...
					<Dialog open={isInviteOpen} onOpenChange={setIsInviteOpen}>
						...
						<DialogContent className="sm:max-w-md">
							<DialogHeader>
								...
								<DialogDescription>
									Convide alguém para colaborar nesta viagem. Eles receberão um email com o convite.
								</DialogDescription>
							</DialogHeader>
											...
											<SelectItem value="viewer" className="py-3">
												<div className="flex items-center gap-2">
													...
													<div>
														...
														<div className="text-xs text-muted-foreground">Apenas visualizar</div>
													</div>
												</div>
											</SelectItem>
											<SelectItem value="editor" className="py-3">
												<div className="flex items-center gap-2">
													...
													<div>
														...
														<div className="text-xs text-muted-foreground">Editar conteúdo</div>
													</div>
												</div>
											</SelectItem>
										</SelectContent>
							...
							<DialogFooter className="gap-2">
								...
								<Button onClick={handleInvite} disabled={!inviteEmail || !inviteEmail.includes("@")}>
					...
					<div className="grid gap-6 md:grid-cols-3">
						<div className="space-y-3">
							<div className="flex items-center gap-3">
								...
								<span className="font-semibold text-foreground">Proprietário</span>
							</div>
							<div className="pl-11 space-y-2">
								<p className="text-sm text-muted-foreground">Controle total da viagem:</p>
						...
						<div className="space-y-3">
							...
							<div className="pl-11 space-y-2">
								<p className="text-sm text-muted-foreground">Pode colaborar ativamente:</p>
								<ul className="text-xs text-muted-foreground space-y-1">

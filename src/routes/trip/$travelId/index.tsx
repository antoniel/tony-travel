...
function ItineraryPage() {
  ...
  const defaultEvent = useMemo(() => {
    ...
    return { title: "", startDate: start, endDate: end, type: "activity" as AppEvent["type"], location: "", cost: null as number | null };
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm">
            <div className="flex items-center gap-2 px-3 py-2 bg-muted/50 rounded-lg">
              ...
              <span className="font-medium">{travel.events?.length || 0} eventos</span>
            </div>
            {canWrite ? (
              <Button
                variant="secondary"
      ...
      {canWrite ? (
        <EventCreateModal
          ...
          onCreate={async () => {
            ...
            await createEventMutation.mutateAsync({ ...newEvent, travelId: travel.id });

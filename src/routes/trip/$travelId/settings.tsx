...
const TravelSettingsSchema = z
  .object({
    name: z.string().min(1, "Nome da viagem é obrigatório").max(255, "Nome muito longo"),
...
function TripSettingsPage() {
  ...
  if (!travel || travel.userMembership?.role !== "owner") {
    return (
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">Apenas proprietários da viagem podem acessar as configurações.</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-2xl font-bold tracking-tight">Configurações da Viagem</h1>
        <p className="text-muted-foreground">Gerencie as configurações e detalhes da sua viagem.</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Atualize as informações básicas da sua viagem.</p>
      </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>O nome que identifica sua viagem.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Adicione detalhes sobre sua viagem que podem ser úteis para outros membros.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
...
function DangerZone({ travel }: { travel: Pick<Travel, "id" | "name"> }) {
  ...
  const deleteForm = useForm<DeleteConfirmationData>({
    resolver: zodResolver(
      DeleteConfirmationSchema.refine((data) => data.confirmationName === travel.name, {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Ações irreversíveis que afetam permanentemente sua viagem.</p>
      </div>

      <div className="rounded-lg border border-destructive/20 bg-destructive/5 p-6 space-y-4">
        <div className="space-y-2">
          <h3 className="text-base font-medium text-destructive">Excluir Viagem</h3>
          <p className="text-sm text-muted-foreground">
            Esta ação não pode ser desfeita. Todos os dados da viagem (acomodações, voos, eventos e membros) serão
        ...
        <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
          ...
          <AlertDialogContent className="max-w-md">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Esta ação é irreversível. Para confirmar, digite o nome exato da viagem abaixo:
                <br />
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction
                disabled={isDeleting || deleteForm.getValues().confirmationName !== travel.name}
                onClick={onDelete}

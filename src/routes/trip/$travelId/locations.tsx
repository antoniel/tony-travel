    ...
    <div className="space-y-10">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6">
        <div className="space-y-3">
          ...
          <p className="text-lg text-muted-foreground">Descubra e organize os locais que você quer visitar</p>
        </div>
          ...
          <div className="max-w-lg mx-auto space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg max-w-md mx-auto">
                Adicione pontos turísticos, restaurantes, museus e outros locais interessantes para criar o roteiro
                perfeito da sua viagem.
              </p>
            </div>
            <div className="space-y-6">

...
import { ArrowLeft, ArrowRight, Check, DollarSign, Loader2, Users } from "lucide-react"
...
const STEPS: WizardStep[] = [
  {
    ...
    description: "Escolha um nome que te inspire e identifique facilmente sua aventura",
...
export default function TripWizard({ initialData }: TripWizardProps) {
  ...
  const getDurationInDays = () => {
    ...
    const diffTime = Math.abs(watchedData.dateRange.to.getTime() - watchedData.dateRange.from.getTime())
  ...
  const renderStep = () => {
    ...
    switch (step.id) {
      ...
      case "summary":
        return <SummaryStep data={watchedData as TripWizardData} getDurationInDays={getDurationInDays} />
      default:
        return null
    }
  }
        ...
        <div className="container relative isolate mx-auto px-4 pt-12 max-w-4xl">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm font-medium text-muted-foreground">{Math.round(progress)}% concluído</span>
            </div>
            ...
            <Card className="travel-card rounded-2xl ring-1 ring-border/60 min-h-[500px]">
              <CardContent className="px-8 py-8">
                ...
                <div className="text-center mb-8">
                  <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-3">{currentStepData.title}</h1>
          ...
          <div className="flex justify-between items-center max-w-3xl mx-auto">
            <Button variant="outline" onClick={handlePrev} disabled={currentStep === 0} className="h-12 px-6">
              ...
              {STEPS.map((step, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    index < currentStep ? "bg-primary" : index === currentStep ? "bg-primary/70" : "bg-secondary"
                  )}
                />
              ))}
            </div>
    ...
    <div className="space-y-6 max-w-md mx-auto">
      <FormField
        ...
        render={({ field, fieldState }) => (
          <FormItem>
            <FormLabel className="text-base font-medium">Nome da viagem</FormLabel>
            <FormControl>
              <Input
                {...field}
                type="text"
            ...
            <FormDescription>Escolha um nome memorável para sua viagem</FormDescription>
            <FormMessage />
          </FormItem>
        )}
      />
          ...
          <div className="flex items-start justify-between py-3">
            ...
            <div className="text-right flex flex-wrap justify-end">
              {data.departureAirports.map((airport: Airport) => (
                <Badge key={airport.code} variant="secondary" className="ml-1 mb-1">

...
export default function TravelInfoSidebar({
	...
	return (
		<div
			className={`${isMinimized ? "w-16" : "w-96"} bg-card border-r h-full overflow-y-auto transition-all duration-300 ${className}`}
		>
			<div className={`${isMinimized ? "p-2" : "p-6"}`}>
				...
				{isMinimized ? (
					/* Minimized sidebar - only show icons */
					...
					<>
						...
						<Collapsible open={visaOpen} onOpenChange={setVisaOpen}>
							<CollapsibleTrigger className="flex items-center justify-between w-full p-3 hover:bg-muted rounded-lg">
								<div className="flex items-center gap-2">
									...
									<CardContent className="p-4">
										<div className="space-y-4 text-sm">
											<div className="flex justify-between items-center">
												...
												<Badge
													variant={
														visaInfo.required ? "destructive" : "secondary"
													}
												>
									...
									<CardContent className="p-4">
										<div className="space-y-3 text-sm">
											...
											<div className="flex items-start gap-3">
												...
												<div>
													<strong>Food Safety:</strong> Stick to bottled water
													and well-cooked food. Street food is generally safe in
													tourist areas.
												</div>
											</div>
											...
											<div className="flex items-start gap-3">
												...
												<div>
													<strong>Transportation:</strong> Book buses in advance
													for popular routes. Uber is available in Lima and
													Cusco.
												</div>
											</div>
